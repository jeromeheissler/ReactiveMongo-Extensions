...
abstract class BsonFileDao[Id <: BSONValue: IdProducer](db: => Future[DB with DBMetaCommands], collectionName: String) extends FileDao[Id, BSONDocument](db, collectionName) {
